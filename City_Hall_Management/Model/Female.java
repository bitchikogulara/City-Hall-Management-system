...
public class Female extends Citizen {
    private List<Marriage> marriages;
    private List<Citizen> children;

    public Female(int idNumber, String fName, String lName, Birth birth, CityHall cityHall) {
        super(idNumber, fName, lName, birth, cityHall);
        this.marriages = new ArrayList<>();
        this.children = new ArrayList<>();
    }

    public Female(int idNumber, String fName, String lName, Birth birth, CityHall cityHall, Death death) {
